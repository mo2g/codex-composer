...
- the Task Card or task journal when one exists
...
6. Map each acceptance criterion to direct evidence, a remaining gap, or an explicit risk.
7. Return verification evidence, residual risks, and one preferred git commit message plus optional alternates.
